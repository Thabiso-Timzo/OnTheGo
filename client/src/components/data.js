...
/*export const carTypeData =[
    ...
    {title:"Premium",
    data:[
   {name:"Black",group :3, price:17.4,image: require('../../assets/images/images/uberBlack.png'),note:"Premium trips in luxury cars",promotion:0,time:"20:31",id:"3"},
   {name:"Van", group:6, price:22.3,image: require('../../assets/images/images/uberVan.png'),note:"Rides for groups up to 6",promotion:12,time:"20:31", id:"4"},
    ]
   },
...
export const carsAround = [
    {latitude:-26.120720,longitude:28.080910},
    {latitude:40.023899,longitude:-82.945511},
    {latitude:-33.947842,longitude:-33.947842},
    {latitude:-26.093090,longitude:27.965010},
